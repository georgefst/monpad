...
viewModel model =
    ...
    --     & lw 3
        ...
        -- I think I originally actually used "pointerup" in Elm version (would explain event name)
        ...
        -- TODO we should call `preventDefault` here (and everywhere?) to prevent e.g. long-press right-click
        -- this was difficult/impossible with elm-collage
