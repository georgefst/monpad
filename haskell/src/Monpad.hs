...
data ClientUpdate
    ...
    deriving (FromJSON) via CustomJSON '[SumObjectWithSingleField] ClientUpdate
...
data ServerUpdate a b
    ...
    deriving (ToJSON) via CustomJSON '[SumObjectWithSingleField] (ServerUpdate a b)
...
data ResetLayout
    ...
    deriving (ToJSON) via CustomJSON '[SumObjectWithSingleField] ResetLayout
...
data ElmFlags = ElmFlags
    ...
    deriving (Show, Generic)
    deriving (ToJSON) via CustomJSON '[SumObjectWithSingleField] ElmFlags
